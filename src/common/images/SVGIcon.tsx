...
import { SVGIconProps } from '../../types/images';




export default function SVGIcon ( { icon: Icon, size = '24px', colour, ...props } : SVGIconProps ) {




    return <Icon stroke={colour} fill={colour} width={size} height={size} {...props} />;
}
